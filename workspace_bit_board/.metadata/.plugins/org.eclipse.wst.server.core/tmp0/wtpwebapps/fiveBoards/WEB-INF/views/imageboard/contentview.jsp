...
<body data-genuitec-lp-enabled="false" data-genuitec-file-id="wc2-4" data-genuitec-path="/fiveBoards/src/main/webapp/WEB-INF/views/imageboard/contentview.jsp">

	<div class="jumbotron" data-genuitec-lp-enabled="false" data-genuitec-file-id="wc2-4" data-genuitec-path="/fiveBoards/src/main/webapp/WEB-INF/views/imageboard/contentview.jsp">
		<h1>${list.bTitle}</h1>
