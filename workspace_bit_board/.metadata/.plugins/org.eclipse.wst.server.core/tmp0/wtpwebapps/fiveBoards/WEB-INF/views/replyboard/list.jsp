...
<body data-genuitec-lp-enabled="false" data-genuitec-file-id="wc2-18" data-genuitec-path="/fiveBoards/src/main/webapp/WEB-INF/views/replyboard/list.jsp">

	<jsp:include page="../navbar.jsp"/>

	<br  data-genuitec-lp-enabled="false" data-genuitec-file-id="wc2-18" data-genuitec-path="/fiveBoards/src/main/webapp/WEB-INF/views/replyboard/list.jsp"/>
